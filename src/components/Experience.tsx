      ...
      {experienceData.map((exp: I_Experience, idx) => (
        ...
        >
          ...
          >
            <div
              className={`${
                exp.job_title === "Freelance" ? "max-sm:ml-1 max-lg:ml-1" : ""
              } flex w-full px-5 max-sm:px-0 max-sm:pr-1 py-3`}
            >
              ...
              <div className="w-full">
                ...
                >
                  ...
                  >
                    <div className="text-lg !leading-4 mb-1 max-sm:text-base font-semibold">
                      {exp.job_title}
                    </div>
