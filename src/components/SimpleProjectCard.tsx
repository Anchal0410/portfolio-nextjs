      ...
      {data.map((project, idx) => (
        ...
        >
          <ShineBorder
            ...
            className="w-full !bg-transparent !pointer-events-none flex max-lg:flex-col max-lg:items-start p-5 md:shadow-xl"
          >
...
const data: Project[] = [
  {
    ...
    description:
      "Textify is an Adobe-funded add-on that enables seamless text extraction from images in Adobe Express, supporting formats like PNG, JPEG, and SVG to enhance creative workflows.",
  },
];
